	...
	<head>
		...
		<link rel="stylesheet" href="{{URL::asset('assets/css/fontawesome-all.css')}}">
		...
		<link rel="stylesheet" href="{{URL::asset('assets/css/video.min.css')}}">
		<link rel="stylesheet" href="{{URL::asset('assets/css/animated-slider.css')}}">
		...
		<link rel="stylesheet" href="{{URL::asset('assets/css/rs6.css')}}">
	...
	<section id="ft-pricing-plan" class="ft-pricing-plan-section page-padding">
		<div class="container">
			<div class="ft-section-title headline pera-content text-center">
				...
				<h2>Our Effective and Affordable
					Pricing Plans
				</h2>
			</div>
				...
				<div class="row justify-content-center">
					<div class="col-lg-4 col-md-6">
						<div class="ft-pricing-plan-items headline ul-li-block text-center position-relative">
							<span class="pricing-shape1 position-absolute"><img src="assets/img/shape/p-sh1.png" alt=""></span>
							<span class="pricing-shape2 position-absolute"><img src="assets/img/shape/p-sh2.png" alt=""></span>
...
<!-- End of FAQ why choose  section
	...
	<script src="{{URL::asset('assets/js/rbtools.min.js')}}"></script>
	<script src="{{URL::asset('assets/js/jquery.cssslider.min.js')}}"></script>
	<script src="{{URL::asset('assets/js/rs6.min.js')}}"></script>
	<script src="{{URL::asset('assets/js/knob.js')}}"></script>
	<script src="{{URL::asset('assets/js/script.js')}}"></script>
	<script src="{{URL::asset('assets/js/gmaps.min.js')}}"></script>
